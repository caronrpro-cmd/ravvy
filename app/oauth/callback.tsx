...
function dispatchProfile(dispatch: ReturnType<typeof useApp>["dispatch"], userInfo: Auth.User) {
  dispatch({
    type: "SET_PROFILE",
    payload: {
      ...
      try {
        ...
        if (params.sessionToken) {
          ...
          if (params.user) {
            try {
              ...
              dispatchProfile(dispatch, userInfo);
            } catch (err) {
        ...
        if (params.code && params.state) {
          ...
          try {
            ...
            logger.debug("[OAuth] Failed to parse as full URL, trying regex");
        ...
        if (result.sessionToken) {
          ...
          logger.error("[OAuth] No session token in result");
          setStatus("error");
