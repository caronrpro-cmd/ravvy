...
export function getSessionCookieOptions(
  ...
  return {
    ...
    httpOnly: true,
    path: "/",
    // SameSite=None requires Secure (HTTPS). Over plain HTTP (local dev with
    // the Metro proxy), use Lax instead — it works in all browsers including
    // Safari, and is sufficient because the proxy makes every API call
